        ...
        <div class="main">
            <div class="main_header">
                <div class="main_header_l">
                    <div class="main_header_l_sousuo">
                        <form method="get" action="${pageContext.request.contextPath}/adminGetAllAlgorithm">
            ...
            <div class="main_01">
                <table width="1041" height="139.333" border="1" style="table-layout: fixed">
                    <tbody>
                    <tr>
                        <th scope="col" width="20%"><div align="center">算法编号</div></th>
                        <th scope="col" width="50%"><div align="center">算法名称</div></th>
...
<%--                        <th scope="col" width="30%"><div align="center">状态</div></th>--%>
                    ...
                    <c:forEach items="${sessionScope.algorithmList}" var="algorithm">
                        <tr>
                            <td width="20%"><div align="center">${algorithm.id}</div></td>
                            <td width="50%"><div align="center">${algorithm.algorithm_name}</div></td>
...
<%--                                <a href="http://localhost:8080/Project06_war//user/prohibitUser?userId=${user.id}"><h4>禁用</h4></a>--%>
                                <a href="http://localhost:8080/Project06_war//deleteAlgorithmById?id=${algorithm.id}"><h4>删除</h4></a>
                            </div></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                ...
                <div class="fenye">
                    <table width="700" height="71" border="0" align="center">
                        <tr>
                            <td width="150" height="65">总共：${AlgorithmPage.total}条数据</td>
                            <td width="200">当前：第${AlgorithmPage.pageNum}/${AlgorithmPage.pages}页</td>
                            <td width="350">请选择：第
                                <c:forEach var="num" begin="1" end="${AlgorithmPage.pages}">
                                    <a href="http://localhost:8080/Project06_war//adminAlgorithmPageInfo?pageNum=${num}">${num}</a>
                                </c:forEach>
                                页</td>
