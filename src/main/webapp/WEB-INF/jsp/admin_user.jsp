    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/goAdmin_algorithm"><i class="fa fa-edit"></i> <span class="nav-label">算法管理</span><span class="fa arrow"></span></a>

                </li>
                <li>
                    <a href="${pageContext.request.contextPath}"><i class="fa fa-edit"></i> <span class="nav-label">帖子管理</span><span class="fa arrow"></span></a>
