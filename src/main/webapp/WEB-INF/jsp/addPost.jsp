...
<%--                </div>--%>
                ...
                <div class="main_01">
                    <form name="post_add" action="${pageContext.request.contextPath}/addPost" method="post" enctype="multipart/form-data">
                        <div>
                            帖子名称：<input type="text" name="name">
                        </div>
                        <div>
                            帖子内容：<input type="text" name="content" class="a">
                        </div>
                        <div class="c">
                            添加照片：<input type="file" name="img" >
